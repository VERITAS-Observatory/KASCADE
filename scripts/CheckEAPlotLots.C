...
//UA-050
void CheckEAPlotsLots(string kNoise="5.55", string cNoise="5.21", string kOff="050", string cOff="050",string zn1="20", string zn2="50", string az1="180", string az2="45")
...
{ 
 ...
 //KASCADE V6 Atm21 All Loose
  //string eak1="$VEGAS/../tables/ea_MDL12UA_V6_PMTUpgrade_ATM21_KASCADE_vegasv250rc5_7sam_Alloff_s400t2_std_MSW1.15_MSL1.4_ThetaSq0.03_LZA.root";
  //string eak2="$VEGAS/../tables/ea_MDL10UA_V6_PMTUpgrade_ATM21_KASCADE_vegasv250rc5_7sam_Alloff_s400t2_std_MSW1.15_MSL1.4_ThetaSq0.03_LZA.root";

 //KASCADE V6 Atm21 050 Loose
  string eak1="$VEGAS/../tables/ea_MDL12UA_V6_PMTUpgrade_ATM21_KASCADE_vegasv250rc5_7sam_050off_s400t2_std_MSW1.15_MSL1.4_ThetaSq0.03_LZA.root";
  string eak2="$VEGAS/../tables/ea_MDL10UA_V6_PMTUpgrade_ATM21_KASCADE_vegasv250rc5_7sam_050off_s400t2_std_MSW1.15_MSL1.4_ThetaSq0.03_LZA.root";
 ...
 //KASCADE V6 Atm21 050 Hard
  //string eak1="$VEGAS/../tables/ea_MDL12UA_V6_PMTUpgrade_ATM21_KASCADE_vegasv250rc5_7sam_050off_s1200t2_std_MSW1.1_MSL1.4_ThetaSq0.01_LZA.root";
  //string eak2="$VEGAS/../tables/ea_MDL10UA_V6_PMTUpgrade_ATM21_KASCADE_vegasv250rc5_7sam_050off_s1200t2_std_MSW1.1_MSL1.4_ThetaSq0.01_LZA.root";
 ...
 //KASCADE V6 Atm21 050 Medium
  //string eak1="$VEGAS/../tables/ea_MDL12UA_V6_PMTUpgrade_ATM21_KASCADE_vegasv250rc5_7sam_050off_s700t2_std_MSW1.1_MSL1.3_MH7.0_ThetaSq0.01_LZA.root";
  //string eak2="$VEGAS/../tables/ea_MDL10UA_V6_PMTUpgrade_ATM21_KASCADE_vegasv250rc5_7sam_050off_s700t2_std_MSW1.1_MSL1.3_MH7.0_ThetaSq0.01_LZA.root";
 ...
 //KASCADE V6 Atm21 050 Soft
 //string eak1="$VEGAS/../tables/ea_MDL12UA_V6_PMTUpgrade_ATM21_KASCADE_vegasv250rc5_7sam_050off_s400t2_std_MSW1.1_MSL1.3_MH7.0_ThetaSq0.03_LZA.root";
 //string eak2="$VEGAS/../tables/ea_MDL10UA_V6_PMTUpgrade_ATM21_KASCADE_vegasv250rc5_7sam_050off_s400t2_std_MSW1.1_MSL1.3_MH7.0_ThetaSq0.03_LZA.root";
...
//GrISUDet
 ...
 //string ea4="$VEGAS/../tables/ea_Oct2012_ua_ATM21_vegasv250rc5_7sam_050off_s400t2_std_MSW1p15_MSL1p4_ThetaSq0p03_LZA_fixed150.root";
  ...
  //string ea1="$VEGAS/../tables/ea_Oct2012_ua_ATM21_vegasv250rc5_7sam_Alloff_s400t2_std_MSW1p1_MSL1p3_MH7_ThetaSq0p03_LZA_fixed150.root";
   ...
   //GrISUDet V6 Atm21 050 Medium
  //string ea1="$VEGAS/../tables/ea_Oct2012_ua_ATM21_vegasv250rc5_7sam_050off_s700t2_std_MSW1p1_MSL1p3_MH7_ThetaSq0p01_LZA_fixed150.root";
  ...
  //string ea1="$VEGAS/../tables/ea_Oct2012_ua_ATM21_vegasv250rc5_7sam_Alloff_s1200t2_std_MSW1p1_MSL1p4_ThetaSq0p01_LZA_fixed150.root";
   ...
   //GrISUDet V6 Atm21 050 Hard
  //string ea1="$VEGAS/../tables/ea_Oct2012_ua_ATM21_vegasv250rc5_7sam_050off_s1200t2_std_MSW1p1_MSL1p4_ThetaSq0p01_LZA_fixed150.root";

   //GrISUDet V6 Atm21 050  LOOSE
  string ea1="$VEGAS/../tables/ea_Oct2012_ua_ATM21_vegasv250rc5_7sam_050off_s400t2_std_MSW1p15_MSL1p4_ThetaSq0p03_LZA_fixed150.root";
 ...
 // ********************************************************************************
  ...
  string tablk1="EffectiveArea_Azimuth_" + az1 + "_Zenith_" + Znk + "_Noise_" + kNoise;   //V4 KASCADE All Offset
  string tablk2="EffectiveArea_Azimuth_" + az2 + "_Zenith_" + Znk + "_Noise_" + kNoise;   //V4 KASCADE All Offset
  ...
  string tabl1="EffectiveArea_Azimuth_" + azc1 + "_Zenith_" + Znk + "_Noise_" + cNoise;   //V4 GrISUDet 050
  string tabl2="EffectiveArea_Azimuth_" + azc2 + "_Zenith_" + Znc + "_Noise_" + cNoise;   //V4 GrISUDet 050
 ...
 for (int i=0;i<6;i++) {
    ...
    tabl1 ="EffectiveArea_Azimuth_" + azc1 + "_Zenith_" + Znc + "_Noise_"  + cNoise;
    tabl2 ="EffectiveArea_Azimuth_" + azc2 + "_Zenith_" + Znc + "_Noise_"  + cNoise;
    if ( kOff != "050" ) {
      tablk1=tablk1 + "_AbsoluteOffset_" + kOff;
      tablk2=tablk2 + "_AbsoluteOffset_" + kOff;;
    }
