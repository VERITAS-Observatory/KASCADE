...
{ 
 ...
 //KASCADE V6 Atm21 All
  string eak1="$VEGAS/../tables/ea_MDL10UA_V6_PMTUpgrade_ATM21_KASCADE_vegasv250rc5_7sam_Alloff_s400t2_std_MSW1.1_MSL1.3_MH7.0_ThetaSq0.03_LZA.root";
    ...
    string eak3="$VEGAS/../tables/ea_MDL10UA_V6_PMTUpgrade_ATM21_KASCADE_vegasv250rc5_7sam_Alloff_s1200t2_std_MSW1.1_MSL1.4_ThetaSq0.01_LZA.root";
  string eak4="$VEGAS/../tables/ea_MDL10UA_V6_PMTUpgrade_ATM21_KASCADE_vegasv250rc5_7sam_Alloff_s400t2_std_MSW1.15_MSL1.4_ThetaSq0.03_LZA.root";
...
//GrISUDet
 ...
 // ********************************************************************************
  ...
  string tablk1="EffectiveArea_Azimuth_" + az1 + "_Zenith_" + znk1 + "_Noise_" + 
  ...
  string tablk2="EffectiveArea_Azimuth_" + az2 + "_Zenith_" + znk2 + "_Noise_" + 
    kNoise;                                            //V4 KASCADE All Offset
  ...
  string tabl1="EffectiveArea_Azimuth_" + az1 + "_Zenith_" + znc1 + "_Noise_" + cNoise;
                                                        //V4 GrISUDet 050
  ...
  string tabl2="EffectiveArea_Azimuth_" + az2 + "_Zenith_" + znc2 + "_Noise_" + cNoise;
                                                         //V4 GrISUDet 050
