 ...
 *
 **/
// Just some string arrays.


#ifndef KSKASCADENAMES_H
#define KSKASCADENAMES_H

#include <string>

const std::string fNameType[18]={"Gamma","Positron","Electron","Mu +","Mu -",
				  "PI 0",
			   "PI +","PI -","K +","K -","K long","K short",
			   "Proton","Neutron","eNeutrino","anti-eNu",
			   "muNeutrino","anti-muNu"};

const std::string fNucleiNames[113]={"Hydrogen", "Helium", "Lithium", 
				      "Beryllium",
